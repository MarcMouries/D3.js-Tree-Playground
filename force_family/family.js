...
function familyChart() {
  ...
  function my(svg) {
    ...
    var simulation = d3.forceSimulation()
      ...
      /* x and y — pull nodes towards the centre with y stronger 
      so nodes fill the landscape screen better. */
      ...
      (default strength is -30 so I’ve made this a bit stronger)*/
      .force("repelForce", repelForce)
      /*    link — specify that id is the link variable */
      .force("link", d3.forceLink().id(function (d) {
        return d.id
      }).distance(dist).strength(1.5))
